...
private _STATICMK30 = STATICMK30;

if ((missionNameSpace getVariable "isNakElite")) then {
	_STATICMK30 = STATICMK30ELT;
};
...
if (_lecallers >= _STATICMK30) then {
	if (_lock1 == 0) then {
		...
		private _leresult = _lecallers - _STATICMK30;
		...
		private _leboxtosend = createVehicle ["B_HMG_01_F", [8419.31, 25116.1, -3.05176e-005], [], 0, 'NONE'];
