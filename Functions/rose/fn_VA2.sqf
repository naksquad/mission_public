...
private _totalxpg = missionNamespace getVariable "therankin";
if (isNil "_totalxpg") then {
	missionNamespace setVariable ["therankin", 0];
	_totalxpg = 0;
};

private _infkilllastxp = missionNamespace getVariable "inftherankin";
if (isNil "_infkilllastxp") then {
	missionNamespace setVariable ["inftherankin", 0];
	_infkilllastxp = 0;
};

private _softvehlastxp = missionNamespace getVariable "softtherankin";
if (isNil "_softvehlastxp") then {
	missionNamespace setVariable ["softtherankin", 0];
	_softvehlastxp = 0;
};

private _amorkilllastxp = missionNamespace getVariable "armmortherankin";
if (isNil "_amorkilllastxp") then {
	missionNamespace setVariable ["armmortherankin", 0];
	_amorkilllastxp = 0;
};

private _airkilllastxp = missionNamespace getVariable "airtherankin";
if (isNil "_airkilllastxp") then {
	missionNamespace setVariable ["airtherankin", 0];
	_airkilllastxp = 0;
};

private _deathlastxp = missionNamespace getVariable "deaththerankin";
...
private _totalRevive = missionNamespace getVariable "totalRevive";
