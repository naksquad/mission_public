...
switch (_TheGodPhase2) do {
   ...
   case "Macer - 3 шт.": {_pylons = "PylonRack_3Rnd_Missile_AGM_02_F"; (vehicle player) setPylonLoadOut [ _prayGod, _pylons, true];};
   case "3 Macer": {_pylons = "PylonRack_3Rnd_Missile_AGM_02_F"; (vehicle player) setPylonLoadOut [ _prayGod, _pylons, true];};
   case "メイサーx3": {_pylons = "PylonRack_3Rnd_Missile_AGM_02_F"; (vehicle player) setPylonLoadOut [ _prayGod, _pylons, true];};
