private _wp1 = (_this # 0) addWaypoint [ (_this # 1), _this # 2];
...
private _wp2 = (_this # 0) addWaypoint [ (_this # 1), _this # 2];
...
private _wp3 = (_this # 0) addWaypoint [waypointPosition _wp1, 0];
