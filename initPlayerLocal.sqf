...
//VileAce added to lock backpacks	
	player addEventHandler ['InventoryOpened',{_this call (missionNamespace getVariable 'ROSE_fnc_clientEventInventoryOpened')}];
...
//VileAce Added to prevent items in the personalized ammo drop
	...
	(findDisplay 46) displayAddEventHandler ["KeyDown", {
		...
		if (uidd in (missionNameSpace getVariable "guirer")) then {  
			if ( _this # 1 == 24 ) then { 
				player addAction ["<t color='#ab2b2c'>---Admin Menu---</t>",{_this spawn ROSE_fnc_lepartrons1;},[],1,false,true,"","player == _originalTarget"];
				...
				player addAction ["<t color='#26de0d'>Map Teleport</t>",{_this spawn ROSE_fnc_lepartrons11;},[],1,false,true,"","player == _originalTarget"];
				player addAction ["<t color='#26de0d'>Delete Vehicle</t>",{_this spawn ROSE_fnc_lepartrons12;},[],1,false,true,"","player == _originalTarget"];
				player addAction ["<t color='#26de0d'>Repair and Refuel</t>",{_this spawn ROSE_fnc_lepartrons13;},[],1,false,true,"","player == _originalTarget"];
				player addAction ["<t color='#26de0d'>Show/Hide Empty Vehicles</t>",{_this spawn ROSE_fnc_lepartrons6;},[],1,false,true,"","player == _originalTarget"];
				player addAction ["<t color='#26de0d'>Give Player $500 and Remove Cooldown</t>",{_this spawn ROSE_fnc_lepartrons2;},[],1,false,true,"","player == _originalTarget"];
				//Test
				player addAction ["<t color='#26de0d'>TP Player to Me</t>",{_this spawn ROSE_fnc_tpToMe;},[],1,false,true,"","player == _originalTarget"];
				player addAction ["<t color='#26de0d'>TP Me to Player</t>",{_this spawn ROSE_fnc_tpToPlayer;},[],1,false,true,"","player == _originalTarget"];
			};
		};
	}];
